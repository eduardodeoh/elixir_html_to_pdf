...
config :html_to_pdf, HtmlToPdfWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "GprJtUv3n4nwuh3Z42Sm1+rwogEgQbLwl2SBqMSOAQj0t9leJhtzZsmH1fq8NqwP",
  watchers: [
...
config :html_to_pdf, dev_routes: true
...
config :html_to_pdf, ChromicPDF, on_demand: true
