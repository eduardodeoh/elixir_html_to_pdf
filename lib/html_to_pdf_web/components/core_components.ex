defmodule HtmlToPdfWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HtmlToPdfWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HtmlToPdfWeb.Gettext, "errors", msg, opts)
    end
  end
